...
Levelseven.prototype.loadScene = function () {

};

Levelseven.prototype.unloadScene = function () {
...
Levelseven.prototype._initText = function (font, posX, posY, color, textH) {
    font.setColor(color);
...
Levelseven.prototype.draw = function () {
...
Levelseven.prototype.update = function () {
    var deltaR = 1.2;
    this.mCamera.update();
