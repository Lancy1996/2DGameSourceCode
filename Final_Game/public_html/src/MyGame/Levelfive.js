...
gEngine.Core.inheritPrototype(Levelfive, Scene);

Levelfive.prototype.loadScene = function () {

};

Levelfive.prototype.unloadScene = function () {
...
Levelfive.prototype.initialize = function () {
...
Levelfive.prototype._initText = function (font, posX, posY, color, textH) {
    font.setColor(color);
...
Levelfive.prototype.draw = function () {
...
Levelfive.prototype.update = function () {
    var deltaR = 1.2;
    this.mCamera.update();
