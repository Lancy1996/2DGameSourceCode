...
gEngine.Core.inheritPrototype(Levelsix, Scene);

Levelsix.prototype.loadScene = function () {
...
Levelsix.prototype.initialize = function () {
...
Levelsix.prototype._initText = function (font, posX, posY, color, textH) {
    font.setColor(color);
...
Levelsix.prototype.draw = function () {
...
Levelsix.prototype.update = function () {
    var deltaR = 1.2;
    this.mCamera.update();
